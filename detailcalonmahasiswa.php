...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p><strong>Status Pendaftaran:</strong> " . htmlspecialchars($data['status']) . "</p>";
        
        // Tampilkan KTP jika tersedia
        if (!empty($data['ktp'])) {
            echo "<p><strong>KTP:</strong></p>";
            echo "<img src='../mahasiswa/" . htmlspecialchars($data['ktp']) . "' alt='KTP' style='width:100%; max-width:300px; display: block; margin-bottom: 20px;'>";
        }
